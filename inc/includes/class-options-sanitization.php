...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'rahulwp' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'rahulwp' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'rahulwp' ),
		'repeat'    => esc_html__( 'Repeat All', 'rahulwp' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'rahulwp' ),
		'top center'    => esc_html__( 'Top Center', 'rahulwp' ),
		'top right'     => esc_html__( 'Top Right', 'rahulwp' ),
		'center left'   => esc_html__( 'Middle Left', 'rahulwp' ),
		'center center' => esc_html__( 'Middle Center', 'rahulwp' ),
		'center right'  => esc_html__( 'Middle Right', 'rahulwp' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'rahulwp' ),
		'bottom center' => esc_html__( 'Bottom Center', 'rahulwp' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'rahulwp')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'rahulwp' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'rahulwp')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'rahulwp' ),
		'italic'      => esc_html__( 'Italic', 'rahulwp' ),
		'bold'        => esc_html__( 'Bold', 'rahulwp' ),
		'bold italic' => esc_html__( 'Bold Italic', 'rahulwp' )
		);
